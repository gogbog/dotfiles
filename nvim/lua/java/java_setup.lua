...
function M:setup()
    ...
    local config = {
        ...
        cmd = {
            ...
            "-Dlog.level=ALL",
            -- 💀
            '-javaagent:' .. vim.fn.stdpath("data") .. package.config:sub(1,1) .. "mason" .. package.config:sub(1,1) .. "packages" .. package.config:sub(1,1) .. "jdtls" .. package.config:sub(1,1) .. "lombok.jar",
            -- lombok path
            "-Xmx1g",
